...
import com.truyengg.service.auth.AuthService;
...
public class AuthController {
  ...
  public ResponseEntity<ApiResponse<TokenResponse>> login(
    ...
    var tokenResponse = authService.login(request, getClientIpAddress(httpRequest), getUserAgent(httpRequest));
  ...
  public ResponseEntity<ApiResponse<UserResponse>> register(
      ...
      HttpServletRequest httpRequest) {
    var user = authService.register(request, getClientIpAddress(httpRequest));
  ...
  public ResponseEntity<ApiResponse<TokenResponse>> refreshToken(
    ...
    var tokenResponse = authService.refreshToken(refreshToken, getClientIpAddress(httpRequest), getUserAgent(httpRequest));
  ...
  public ResponseEntity<ApiResponse<UserResponse>> getCurrentUser(
    ...
    var user = authService.getCurrentUser(userPrincipal.id());
