...
public class AdminComicController {
  ...
  public ResponseEntity<ApiResponse<Page<ComicResponse>>> getAllComics(
    ...
    var responses = comics.map(this::enrichComicResponse);
  ...
  public ResponseEntity<ApiResponse<ComicResponse>> updateStatus(
    ...
    return ResponseEntity.ok(ApiResponse.success(enrichComicResponse(comic)));
  }
  ...
  public ResponseEntity<ApiResponse<ComicResponse>> mergeComics(
    ...
    return ResponseEntity.ok(ApiResponse.success(enrichComicResponse(merged)));
  }
  ...
  private ComicResponse enrichComicResponse(Comic comic) {
