...
public class AdminSettingsController {
  ...
  public ResponseEntity<ApiResponse<SettingCategoryResponse>> getCategories() {
    var tree = settingService.getCategory();
  ...
  public ResponseEntity<ApiResponse<SettingDetail>> getSettingById(@PathVariable Long id) {
  ...
  public ResponseEntity<ApiResponse<SettingDetail>> getSettingByFullKey(@RequestParam String fullKey) {
  ...
  public ResponseEntity<ApiResponse<SettingDetail>> updateSetting(
