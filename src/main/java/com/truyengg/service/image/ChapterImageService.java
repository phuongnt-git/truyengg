...
public class ChapterImageService {
  ...
  public void updateImageDownloadStatus(Long imageId, String storedUrl, boolean isDownloaded) {
    updateImageDownloadStatus(imageId, storedUrl, null, isDownloaded);
  }

  @Transactional
  public void updateImageDownloadStatus(Long imageId, String storedUrl, String blurhash, boolean isDownloaded) {
